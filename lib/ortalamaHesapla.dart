import 'package:dynamic_grade_avarage/class.dart';
              ...
              child: RichText(
                ...
                text: TextSpan(
                  children: [
                    TextSpan(
                      text:
                      tumDersler.length == 0 ? "Ders Ekleyin" : "Ortalama:",
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 20,
                      ),
...
//            color: Colors.pink.shade200,
  ...
  void ortalamayiHesapla() {
    ...
    for (var oankiDers in tumDersler) {
      ...
      toplamNot = toplamNot + (dersHarfDegeri * kredi);
      toplamKredi += kredi;
    }
